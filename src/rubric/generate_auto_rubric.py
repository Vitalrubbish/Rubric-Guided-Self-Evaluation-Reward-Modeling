...
DIMENSION_SPECS = [
    {
        ...
        "linked_patterns": [
            "logic_wrong_output",
            "logic_wrong_output_value",
            "logic_wrong_output_type",
            "logic_wrong_output_length",
        ],
        "score_criteria": {
    ...
    },
    {
        ...
        "linked_patterns": [
            "runtime_missing_required_interface",
            "runtime_name_error",
    ...
    },
    {
        ...
        "linked_patterns": [
            ...
            "runtime_exception_on_test_case",
...
def collect_examples(taxonomy: dict) -> dict[str, list[dict]]:
    ...
    for cluster in taxonomy.get("patterns", []):
        patterns = cluster.get("rule_patterns") or cluster.get("error_patterns")
        if isinstance(patterns, dict):
            pattern_names = list(patterns)
        elif isinstance(patterns, list):
            pattern_names = patterns
        elif cluster.get("pattern"):
            pattern_names = [cluster.get("pattern")]
        else:
            pattern_names = [cluster.get("name")]
