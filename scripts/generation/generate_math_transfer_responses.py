#!/usr/bin/env python3
"""Generate MATH transfer responses with a base model and optional LoRA adapter."""
...
def main() -> None:
    ...
    parser.add_argument("--input", type=Path, default=Path("data/processed/math_transfer_prompts_n100.jsonl"))
    parser.add_argument("--output", type=Path, default=Path("data/responses/math_transfer_qwen25_n50.jsonl"))
    ...
    if not torch.cuda.is_available():
        raise RuntimeError("CUDA is required for MATH generation")
    ...
    print(f"wrote {generated} MATH responses to {args.output}")
