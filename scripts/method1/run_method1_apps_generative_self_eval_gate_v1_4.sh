...
GPU=${GPU:-2}
ADAPTER=${ADAPTER:-outputs/apps_simple_method1_generative_self_evaluator_sft_lora_v1_4_data_repair}

INPUT=${INPUT:-data/sft/apps_simple_method1_generative_self_evaluator_v1_4_data_repair.jsonl}
GENERATIONS=${GENERATIONS:-data/evaluator/apps_simple_method1_generative_self_eval_v1_4_data_repair_test_generations.jsonl}
SUMMARY=${SUMMARY:-data/evaluator/apps_simple_method1_generative_self_eval_v1_4_data_repair_test_summary.json}
PREDICTIONS=${PREDICTIONS:-data/evaluator/apps_simple_method1_generative_self_eval_v1_4_data_repair_test_predictions.jsonl}
REPORT=${REPORT:-docs/method1/43-generative-self-evaluator-v1-4-data-repair-test-results.md}
...
echo "Generative self-eval v1.4 free-generation gate complete: $SUMMARY"
