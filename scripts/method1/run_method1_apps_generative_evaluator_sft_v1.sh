...
DATA=${DATA:-data/sft/apps_simple_method1_generative_self_evaluator_v1.jsonl}
OUTPUT_DIR=${OUTPUT_DIR:-outputs/apps_simple_method1_generative_self_evaluator_sft_lora_v1}
