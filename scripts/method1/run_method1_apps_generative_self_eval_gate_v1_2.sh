...
GENERATIONS=${GENERATIONS:-data/evaluator/apps_simple_method1_generative_self_eval_v1_2_answer_first_test_generations.jsonl}
SUMMARY=${SUMMARY:-data/evaluator/apps_simple_method1_generative_self_eval_v1_2_answer_first_test_summary.json}
PREDICTIONS=${PREDICTIONS:-data/evaluator/apps_simple_method1_generative_self_eval_v1_2_answer_first_test_predictions.jsonl}
REPORT=${REPORT:-docs/method1/38-generative-self-evaluator-v1-2-answer-first-test-results.md}
...
echo "Generative self-eval v1.2 gate complete: $SUMMARY"
