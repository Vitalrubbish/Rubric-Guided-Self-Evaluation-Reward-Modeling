...
GPU=${GPU:-2}
ADAPTER=${ADAPTER:-outputs/apps_simple_method1_generative_self_evaluator_sft_lora_v1}

INPUT=${INPUT:-data/sft/apps_simple_method1_generative_self_evaluator_v1.jsonl}
GENERATIONS=${GENERATIONS:-data/evaluator/apps_simple_method1_generative_self_eval_v1_test_generations.jsonl}
SUMMARY=${SUMMARY:-data/evaluator/apps_simple_method1_generative_self_eval_v1_test_summary.json}
PREDICTIONS=${PREDICTIONS:-data/evaluator/apps_simple_method1_generative_self_eval_v1_test_predictions.jsonl}
REPORT=${REPORT:-docs/method1/35-generative-self-evaluator-v1-test-results.md}
...
echo "Generative self-eval gate complete: $SUMMARY"
