...
OUTPUT=${OUTPUT:-data/sft/apps_simple_method1_generative_self_evaluator_v1.jsonl}
SPLIT_OUTPUT_DIR=${SPLIT_OUTPUT_DIR:-data/sft/apps_simple_method1_generative_self_evaluator_v1}
SUMMARY_OUTPUT=${SUMMARY_OUTPUT:-data/sft/apps_simple_method1_generative_self_evaluator_v1_summary.json}
...
echo "Generative evaluator SFT data complete: $OUTPUT"
