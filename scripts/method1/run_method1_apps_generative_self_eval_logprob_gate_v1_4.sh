...
SCORES=${SCORES:-data/evaluator/apps_simple_method1_generative_self_eval_v1_4_data_repair_logprob_scores.jsonl}
SUMMARY=${SUMMARY:-data/evaluator/apps_simple_method1_generative_self_eval_v1_4_data_repair_logprob_summary.json}
REPORT=${REPORT:-docs/method1/42-generative-self-evaluator-v1-4-data-repair-logprob-results.md}
...
echo "Generative self-eval v1.4 logprob gate complete: $SUMMARY"
